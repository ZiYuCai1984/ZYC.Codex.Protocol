...
public class McpServerElicitationRequestParamsOpenaiForm : McpServerElicitationRequestParams
{
    ...
    public string Mode
    {
        ...
        private set
        {
            if (value != "openai/form")
            {
                throw new JsonException("Expected McpServerElicitationRequestParamsOpenaiForm.mode to be openai/form.");
            }
        }
    }
    ...
    [JsonRequired]
    [JsonIgnore(Condition = JsonIgnoreCondition.Never)]
    public JsonElement RequestedSchema { get; set; } = default!;
