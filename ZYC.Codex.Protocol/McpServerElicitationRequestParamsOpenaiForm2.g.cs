...
public class McpServerElicitationRequestParamsOpenaiForm2 : McpServerElicitationRequestParams
{
    ...
    public string Mode
    {
        ...
        private set
        {
            if (value != "openaiForm")
            {
                throw new JsonException("Expected McpServerElicitationRequestParamsOpenaiForm2.mode to be openaiForm.");
            }
        }
    }
